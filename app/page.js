...
const practiceAreas = [
  ...
  },
  {
    ...
    title: 'قانون الشغل',
    description: 'ندافع عن حقوق العمال وأصحاب العمل في جميع جوانب قانون العمل.',
  },
  {
    icon: '/images/icon-family-law.svg',
    title: 'قانون الأسرة',
    description: 'نتعامل مع قضايا الأسرة، بما في ذلك الزواج والطلاق وحضانة الأطفال.',
  },
  {
    icon: '/images/icon-criminal-law.svg',
    title: 'القانون الجنائي',
    description: 'نوفر دفاعًا قويًا في القضايا الجنائية، من الجنح إلى الجنايات.',
  },
]
    ...
    <>
      ...
      <section id="practice-areas" className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-primary text-center mb-12">مجالات الخبرة</h2>
